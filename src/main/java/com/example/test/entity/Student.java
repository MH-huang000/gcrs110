...
public class Student {
    ...
    public void moveOut(CourseData courseData) {
        for (CourseData temp : courseDatas) {
            if (temp.getCourseDataId() == courseData.getCourseDataId()) {
                courseDatas.remove(temp);
                break;
            }
        }
        System.out.println("Student's courseDate move out " + courseData.getSubject().getCname());
    }
    ...
    public void moveIn(CourseData courseData) {
        ...
        System.out.println("Student's courseDate move in " + courseData.getSubject().getCname());
    }
}
